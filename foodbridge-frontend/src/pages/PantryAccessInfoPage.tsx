...
export default function PantryAccessInfoPage() {
  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: '#fafaf8' }}>
      ...
      <section
        ...
        style={{
          backgroundImage: 'linear-gradient(rgba(0,0,0,0.6), rgba(0,0,0,0.6)), url(https://images.unsplash.com/photo-1542838132-92c53300491e?w=1200&q=80)',
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8 py-24 flex items-center">
          <div className="max-w-xl">
            ...
            <p className="text-gray-300 text-lg leading-relaxed">
              Schedule pantry appointments and get essential groceries — no stress, no long lines.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 px-6 lg:px-8">
        <div className="max-w-4xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
            {[
              { icon: '🗓️', title: 'Book a Slot', desc: 'Pick a convenient time from available pantry appointment slots. No more waiting in line — your visit is scheduled and ready.' },
              { icon: '🧺', title: 'Smart Cart', desc: 'Our AI generates a personalized grocery cart based on your past orders and dietary preferences, saving you time.' },
              { icon: '📦', title: 'Track Your Order', desc: 'View your upcoming appointments, modify them if plans change, and get reminders before your pickup time.' },
            ].map((item) => (
          ...
          <div className="rounded-2xl p-8 mb-10" style={{ backgroundColor: '#2a7c6f' }}>
            ...
            <ol className="text-green-100 text-sm leading-relaxed space-y-2 list-decimal list-inside">
              <li>Browse available pantry appointment slots and pick a time that works for you.</li>
              <li>Let the AI suggest a grocery cart based on your history, or build your own.</li>
              <li>Confirm your appointment — you'll receive a reminder before your visit.</li>
              <li>Show up, collect your items, and you're done. Reschedule anytime if needed.</li>
            </ol>
          </div>

          <div className="text-center">
            <p className="text-gray-500 mb-4">Access essential groceries on your schedule.</p>
            <button
              onClick={() => navigate('/register')}
